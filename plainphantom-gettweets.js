...
steps = [
    ...
    function(){
		...
		page.evaluate(function(){
			document.getElementsByName("session[username_or_email]")[1].value="luka.ramishvili@gmail.com";
			document.getElementsByName("session[password]")[1].value="tomtailorfiddle1";
